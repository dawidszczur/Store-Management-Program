...
Store management system using object-oriented principles to handle items, employees, and customers.

System Overview
* Store Manager: Responsible for managing the objects in the store, including items,
